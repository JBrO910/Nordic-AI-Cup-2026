...
import importlib; spec = sys.argv[3] if len(sys.argv) > 3 else "src.utils.controllers.hivemind_policy:Hivemind"; Hivemind = getattr(importlib.import_module(spec.split(":")[0]), spec.split(":")[1])
